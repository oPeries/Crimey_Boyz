...
class researcher extends CI_Controller {
    ...
    public function about() {
        $data['page'] = 'basic';
        $this->load->view('header', $data);
        $this->load->view('researcher-about');
        $this->load->view('footer');
    }
    ...
    public function register() {
        ...
        $this->form_validation->set_rules(
            'username', 'Username',
            'required|min_length[5]|max_length[12]|is_unique[researcher.username]',
            array(
        ...
        $this->form_validation->set_rules('email', 'Email', 'required|valid_email|is_unique[researcher.email]');
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->researcher_model->insert_user($data);
    ...
    public function login() {
        ...
        $remembername = $this->input->post('remember-name');
